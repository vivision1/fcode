...
ifeq ($(uname_S), Windows)
	...
	LDFLAGS+= -ldlibw64 
	DFLAGS= -DWIN32 -DSCI_LEXER -DSCI_NAMESPACE  -D_CRT_SECURE_NO_DEPRECATE -D_SCL_SECURE_NO_WARNINGS -D_WINDOWS -D_USRDLL
...
LDFLAGS+=  $(shell pkg-config  gtk+-3.0   gmodule-no-export-2.0 --libs) 
